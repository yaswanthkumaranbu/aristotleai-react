...
//                           }}
//                         >
//                           <span className ="sidebar-icon" style={{border:'1px'}}>
//                             <img
...
//                       <li
//                         className={`nav-item ${currentMenu == "Character" ? "active" : ""
//                           }`}
...
//             />
//           </span>
//           <span className="sidebar-text">Chimera AI</span>
//         </Link>
...
//                             </svg>
//                           </span>
//                           <button className="sidebar-text" onClick={()=> setButtonPopup(true)}>
//                               Connect with us

//                           </button>
//                           <Popup trigger={buttonPopup} setTrigger={setButtonPopup}>

//                             <h2 style={{textAlign:'center'}}>Connect</h2> <h3 style={{textAlign:'center'}}><a href="https://www.chimeratechnologies.com/">enquiries@chimeratechnologies.com</a></h3>
//                             </Popup>
//                         </a>
//                       </li>
//                     </ul>
...
//                 <li className="nav-item dropdown" onClick={()=> setNotify(!notify)}>
//                   <a
...
//                     <Notify className="itis" trigger={notify} setTrigger={setNotify}>
